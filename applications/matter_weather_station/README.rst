...
#. Build the application:
   ...
   .. tabs::
      ...
      .. group-tab:: nRF Connect for VS Code
         ...
         For example: ``-- -Dmatter_weather_station_SHIELD=nrf7002eb -DFILE_SUFFIX=release -DSB_CONFIG_WIFI_NRF70=y -DCONFIG_CHIP_WIFI=y``.
      ...
      .. group-tab:: Command line
         ...
         .. code-block:: console
            ...
            west build -b thingy53/nrf5340/cpuapp -- -Dmatter_weather_station_SHIELD=nrf7002eb -DFILE_SUFFIX=release -DSB_CONFIG_WIFI_NRF70=y -DCONFIG_CHIP_WIFI=y
