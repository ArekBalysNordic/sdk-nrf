...
private:
	static constexpr size_t kMaxEntriesNumber = CONFIG_NCS_MATTER_SECURE_STORAGE_MAX_ENTRY_NUMBER;
	static constexpr psa_storage_uid_t kKeyOffset = CONFIG_NCS_MATTER_SECURE_STORAGE_PSA_KEY_VALUE_OFFSET;
