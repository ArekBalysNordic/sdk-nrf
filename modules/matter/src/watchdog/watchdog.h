...
namespace Watchdog
{
	...
	public:
		 ...
		 * If this callback cannot be called within the CONFIG_NCS_MATTER_WATCHDOG_TIMEOUT timeout the
		 * reboot occurs.
		 *
		 ...
		 * CONFIG_NCS_MATTER_WATCHDOG_TIMEOUT then the reboot occurs.
		 *
		 ...
		 * CONFIG_NCS_MATTER_WATCHDOG_TIMEOUT then the device reboot occurs.
		 *
