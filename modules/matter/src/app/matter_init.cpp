...
#ifdef CONFIG_NCS_MATTER_SETTINGS_SHELL
#include "persistent_storage/persistent_storage_shell.h"
#endif

#ifdef CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS
...
#ifdef CONFIG_NCS_MATTER_TEST_EVENT_TRIGGERS_REGISTER_DEFAULTS
#include "event_triggers/default_event_triggers.h"
#endif
#endif

#ifdef CONFIG_NCS_MATTER_WATCHDOG_DEFAULT
#include "app/task_executor.h"
#include "watchdog/watchdog.h"
#endif

#ifdef CONFIG_NCS_MATTER_TEST_SHELL
...
#endif /* CONFIG_NCS_MATTER_TEST_EVENT_TRIGGERS_REGISTER_DEFAULTS */
#endif /* CONFIG_NCS_MATTER_TEST_EVENT_TRIGGERS */
#else
...
/* Set KMUKeyAllocator for devices that supports KMU */
...
#ifdef CONFIG_NCS_MATTER_OPERATIONAL_KEYS_MIGRATION_TO_ITS
	...
	static Nrf::Watchdog::WatchdogSource sAppWatchdog(CONFIG_NCS_MATTER_WATCHDOG_DEFAULT_FEED_TIME,
							  FeedFromApp);
	static Nrf::Watchdog::WatchdogSource sMatterWatchdog(CONFIG_NCS_MATTER_WATCHDOG_DEFAULT_FEED_TIME,
							     FeedFromMatter);
