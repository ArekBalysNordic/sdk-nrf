...
#ifdef CONFIG_NCS_MATTER_FACTORY_RESET_ON_KEY_MIGRATION_FAILURE
		if (CHIP_NO_ERROR != err) {
...
#endif /* CONFIG_NCS_MATTER_FACTORY_RESET_ON_KEY_MIGRATION_FAILURE */

		return err;
	}
#endif /* CONFIG_NCS_MATTER_OPERATIONAL_KEYS_MIGRATION_TO_ITS */
} /* namespace Migration */
} /* namespace Nrf::Matter */
