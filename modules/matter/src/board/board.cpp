...
{
#ifndef CONFIG_NCS_MATTER_CUSTOM_BLUETOOTH_ADVERTISING
	if (action == ButtonAction::Pressed) {
...
#endif /* CONFIG_NCS_MATTER_CUSTOM_BLUETOOTH_ADVERTISING */
}
