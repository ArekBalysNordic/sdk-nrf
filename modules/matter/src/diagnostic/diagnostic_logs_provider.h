...
#if defined(CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_END_USER_LOGS) ||                                                 \
	defined(CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_NETWORK_LOGS)
...
#ifdef CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_TEST
...
#if defined(CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_NETWORK_LOGS) &&                                                  \
	defined(CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_END_USER_LOGS)
...
#elif defined(CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_NETWORK_LOGS)
	DiagnosticLogProvider() : mNetworkLogs(DEVICE_DT_GET(DT_NODELABEL(network_logs_retention))) {}
#elif defined(CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_END_USER_LOGS)
...
#ifdef CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_NETWORK_LOGS
	DiagnosticLogsRetention mNetworkLogs;
#endif /* CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_NETWORK_LOGS */

#ifdef CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_END_USER_LOGS
	DiagnosticLogsRetention mEndUserLogs;
#endif /* CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_END_USER_LOGS */
};
