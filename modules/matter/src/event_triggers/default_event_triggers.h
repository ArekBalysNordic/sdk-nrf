...
#ifdef CONFIG_NCS_MATTER_WATCHDOG_EVENT_TRIGGERS
	/* Watchdog */
...
#ifdef CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_CRASH_LOGS
	DiagnosticLogsCrash = 0xFFFF'FFFF'6000'0000,
#endif /* CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_CRASH_LOGS */
#endif /* CONFIG_NCS_MATTER_DIAGNOSTIC_LOGS_TEST */
};
