...
public:
	...
	*/
	...
	constexpr static TriggerSlot kMaxEventTriggers = CONFIG_NCS_MATTER_TEST_EVENT_TRIGGERS_MAX;
	constexpr static TriggerSlot kInvalidTriggerSlot = CONFIG_NCS_MATTER_TEST_EVENT_TRIGGERS_MAX + 1;
