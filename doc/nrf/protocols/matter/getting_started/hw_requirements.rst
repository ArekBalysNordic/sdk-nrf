...
.. tabs::
   ...
   .. tab:: nRF54L15 DK + TF-M

      The following memory map is valid for Matter applications running on the :ref:`nRF54L15 DK <programming_board_names>` (:ref:`nrf54l15dk/nrf54l15/cpuapp/ns <zephyr:nrf54l15dk_nrf54l15>`).
      ...
      Application core flash (size: 0x17D000 = 1524kB)
        ...
        |                                         |                     |                   +---------------------+-----------------+-------------------+
        |                                         |                     |                   | tfm                 | 50kB (0xc800)   | 1026kB (0x1f800)  |
        +-----------------------------------------+---------------------+-------------------+---------------------+-----------------+-------------------+
