...
To enable diagnostic log support, you must use the :ref:`diagnostic logs snippet <snippet_matter_diagnostic_logs>`, which contains required devicetree overlays.
...
Because it uses the retained RAM partition, the :ref:`snippet_matter_diagnostic_logs` must be added to the build to enable crash log support.
