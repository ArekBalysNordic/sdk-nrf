...
See the :file:`overlays/tcp.conf` configuration overlay file in the :ref:`ot_cli_sample` sample directory for an example on how to enable the alternative TCP implementation.
