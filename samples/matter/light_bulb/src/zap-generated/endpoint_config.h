...
\
  ...
  { 0x00004003, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(WRITABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE), ZAP_EMPTY_DEFAULT() }, /* StartUpOnOff */  \
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 15, 369 }, \
  { ZAP_CLUSTER_INDEX(15), 6, 40 }, \
}
...
// Array of device ids
#define FIXED_DEVICE_IDS { 22, 257 }
