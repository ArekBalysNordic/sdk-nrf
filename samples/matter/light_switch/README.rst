...
See the :ref:`matter:chip_tool_guide` page in the Matter documentation for the CHIP Tool's setup information.
...
You can read more about ACLs on the :ref:`matter:access_control_guide` in the Matter documentation.
...
#. Use the :ref:`CHIP Tool <matter:chip_tool_guide>` ("Writing ACL to the ``accesscontrol`` cluster" section) to add proper ACL for the light bulb device.
