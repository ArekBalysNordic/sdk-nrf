...
* Matter over Thread - secure storage backend (:ref:`CONFIG_NCS_MATTER_SECURE_STORAGE_BACKEND<CONFIG_NCS_MATTER_SECURE_STORAGE_BACKEND>` Kconfig option enabled by default).
* Matter over Wi-Fi - non-secure storage backend (:ref:`CONFIG_NCS_MATTER_SETTINGS_STORAGE_BACKEND<CONFIG_NCS_MATTER_SETTINGS_STORAGE_BACKEND>` Kconfig option enabled by default).
