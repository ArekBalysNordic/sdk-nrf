...
.. tabs::
   ...
   .. group-tab:: nRF54 DKs
      ...
      #. Press **Button 1** on a client node to control **LED 1** on all server nodes.
      #. Pair a client with a server by completing the following steps:
      ...
      #. Press **Button 0** on the client node to control the **LED 1** on the paired server node.
...
.. tabs::
   ...
   .. group-tab:: nRF54 DKs
      ...
      #. In nRF Toolbox, tap the middle button to control **LED 1** on all CoAP server nodes.
      #. To pair a client with a server, complete the following steps:
