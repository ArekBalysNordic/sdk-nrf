...
.. parsed-literal::
   ...
   west build -b *board_target* -p -- -DEXTRA_CONF_FILE=overlays/multiprotocol.conf

Low power mode
==============

The low power mode feature enables the Thread CLI sample to enter a low power mode when the device is not actively participating in the Thread network.
...
.. parsed-literal::
   ...
   west build -b *board_target* -p -- -DEXTRA_CONF_FILE=overlays/low_power.conf -DEXTRA_DTC_OVERLAY_FILE=overlays/low_power.overlay
...
.. parsed-literal::
   ...
   west build -b *board_target* -p -- -DEXTRA_CONF_FILE=overlays/tcp.conf
...
.. parsed-literal::
   ...
   west build -b *board_target* -p -- -DEXTRA_CONF_FILE=overlays/tcat.conf
...
To switch to USB transport on targets that use UART by default, :ref:`activate the ot-usb snippet <ot_cli_sample_activating_variants>`.
